          ...
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-3">
                <img src="https://duk.tw/krREUe.png" alt="Star Future Auto-Guangzhou" className="h-10 sm:h-12 md:h-16 w-auto" referrerPolicy="no-referrer" />
                <span className="font-bold text-sm sm:text-base md:text-lg leading-tight tracking-tight">
                  Star Future Auto-Guangzhou
                </span>
              </Link>
            </div>
